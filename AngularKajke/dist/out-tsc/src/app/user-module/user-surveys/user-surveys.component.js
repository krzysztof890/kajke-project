...
var UserSurveysComponent = /** @class */ (function () {
    function UserSurveysComponent(surveyService) {
        ...
        this.subs = new Array();
        this.subs.push(surveyService.isRequestingObservable.subscribe(function (isDownloading) { return _this.isDownloading = isDownloading; }));
        // pobierz ankiety uzytkownika
        this.subs.push(this.surveyService.getUserSurveys()
            .subscribe(function (res) { return _this.surveys = res; }));
    ...
    UserSurveysComponent.prototype.ngOnDestroy = function () {
