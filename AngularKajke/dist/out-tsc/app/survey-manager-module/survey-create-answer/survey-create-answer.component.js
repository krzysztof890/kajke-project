...
var SurveyCreateAnswerComponent = /** @class */ (function () {
    ...
    SurveyCreateAnswerComponent.prototype.addAnswer = function () {
        ...
        if (this.viewContainerRef.length === 0 || this.answers.last().trim().length !== 0) {
            ...
            this.componentLoaderService.addChild(AnswerComponent, (_a = {}, _a['BindingProperty'] = this.answers, _a['handler'] = new MethodHandler(this, ['remoweAnswerAt ', ' addAnswer ']), _a['changeIndex'] = this.answerRemowedAtObservable, _a));
            return true;
        }
        return false;
        var _a;
